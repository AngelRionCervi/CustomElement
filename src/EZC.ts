...
export function createComp(name: string, defineComp: Function) {
    customElements.define(
        ...
        class extends HTMLElement {
            ...
            private setStateQueue: any[];
            private setState: (key: any, val: any) => void;
            private cycle: { beforeInit: () => undefined; onInit: () => undefined; onRender: () => undefined };
            private props: any;
            constructor() {
                super();
                ...
                const registerFn = (fns: registerFn[]) => {
