        ...
        class extends HTMLElement {
            constructor() {
                ...
                const createState = (initState = {}) => {
                    store.add(this.storeSymbol, initState);
                    this.setState = (key, val) => {
                        this.setStateQueue.unshift({key, val});
                        this.execSetStateQueue();
                    }
                    return { state: store.get(this.storeSymbol), setState: this.setState };
                }
                ...
                const html = defineComp({ createState, registerFn, cycle, store });
