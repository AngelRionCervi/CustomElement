...
export default class CustomElement extends HTMLElement {
    ...
    detectBinds(node = null) {
        if (!node) {
            ...
            console.log(this.binds.get(TEXT_BIND).length)
        }
    }
                ...
                case CLASS_BIND: {
                    ...
                    if (node) {
                        if (contains) {
                            ...
                            corBinds = corBinds.filter((bind) => bind.elems.some((el) => el.isSameNode(node)));
                        }
                    }
                    break;
                }
...
/* to try : 
dont save the elements when scanning for binds
